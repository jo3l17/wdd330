        ...
        squares[i].onclick = () => {
            ...
            if (squares[index + 7].classList.contains('taken') && !squares[index].classList.contains('taken')) {
                if (currentPlayer === 1) {
                    ...
                    squares[index].classList.add('p1');
                    currentPlayer = 2;
                    ...
                    squares[index].classList.add('taken');
                    squares[index].classList.add('p2');
                    currentPlayer = 1;
                    player.textContent = `Player ${currentPlayer}`;
...
function stopgame() {
    squares.forEach(square => {square.removeEventListener('click', checkBoard);square.classList.add('taken')});
}
